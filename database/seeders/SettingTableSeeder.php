...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'oubdaalassane01@gmail.com']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'B-Stock']);
        }
        ...
        if (! keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'Alassane Oubda']);
        }

        if (! keyExist('footer')) {
            Setting::create([
                'key' => 'footer', 'value' => \App\Support\FeatureCatalog::FOOTER,
            ]);
        }
        ...
        if (! keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => 'Abidjan, Côte d\'Ivoire',
            ]);
        }
