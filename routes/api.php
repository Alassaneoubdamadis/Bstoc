...
Route::middleware(['auth:sanctum', 'tenant', 'subscription', 'features'])->group(function () {
...
Route::post('geniuspay/webhook', [\App\Http\Controllers\API\GeniusPayWebhookController::class, 'handle']);
...
Route::middleware(['auth:sanctum', 'tenant'])->group(function () {
    ...
    Route::get('subscription/verify', [\App\Http\Controllers\API\SubscriptionController::class, 'verify']);
});

Route::post('login', [AuthController::class, 'login'])->name('login');
Route::post('register', [AuthController::class, 'register'])->middleware('public.register');
