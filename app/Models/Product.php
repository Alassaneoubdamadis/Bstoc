...
{
    use BelongsToCompany, HasFactory, InteractsWithMedia, HasJsonResourcefulData;
    ...
    public function prepareProducts(): array
    {
        ...
        $unitName = $this->getProductUnitName();
        ...
        return [
            ...
            'sale_unit' => is_array($unitName) ? (array_values($unitName)[1] ?? '') : '',
